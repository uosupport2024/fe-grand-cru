...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-text-prim flex items-center justify-center sm:p-4 relative overflow-hidden font-sans selection:bg-brand-secondary/40">
      ...
      {/* Main Container mirroring a mobile screen on desktop, full screen on mobile */}
      <div className="w-full h-screen sm:h-[720px] sm:max-w-[400px] sm:aspect-[9/19] sm:rounded-[40px] sm:border-[8px] sm:border-brand-primary bg-brand-primary-dark sm:shadow-2xl overflow-y-auto relative z-10 scrollbar-none flex flex-col">
        ...
        {/* Top Header Section with Logo at the top */}
        <div className="relative h-[180px] w-full overflow-hidden shrink-0">
          ...
          >
            <div className="w-full flex justify-start">
              <GrandCruLogo className="h-9 w-auto object-contain block" />
            </div>
        ...
        <div className="px-6 py-4 flex flex-col justify-start bg-brand-primary-dark shrink-0">
          ...
          <div className="text-center mt-4">
            <span className="text-[10px] text-neutral-surface/60 font-sans">
              ...
              <Link to="/login" className="text-brand-secondary font-medium hover:underline">
                Sign In
              </Link>
            </span>
          </div>
        ...
        <div className="px-6 pb-8 pt-6 bg-brand-primary-dark flex flex-col shrink-0 text-left">
